//есть таблица стоимости покраски цифр например cost [5,6,7 ....]
// это значит что покрасить 1-цу стоит 5 грн, 2-ку 6 грн , 3-ку 7 грн и т.д.
// и есть число - количество  денег  target  на покраску
// надо выбрать ноибольшее количество цифр и каких  мы можем покрасить
// чтобы ровно уложиться в количество данных денег
